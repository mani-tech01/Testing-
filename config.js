...
module.exports = {
     ...
     * @default "mongodb+srv://..."
     */
    MONGODB_URI: process.env.MONGODB_URI || 'mongodb+srv://Mani01:<db_password>@cluster0.3itkray.mongodb.net/?appName=Cluster0',
    ...
    // ── Channel Settings ──
    CHANNEL_JID: '120363420486385183@newsletter',
    
    CHANNEL_IDS: [
        '120363420486385183@newsletter'
    ],
     ...
     * @type {string}
     */
    BOT_NAME: process.env.BOT_NAME || '💕⃝🕊️ 𝙈𝘼𝙉𝙄 𝗠𝗗 𝗠𝗶𝗻𝗶 💕⃝🕊️',

    /**
     * @description Owner name
     * @type {string}
     */
    OWNER_NAME: process.env.OWNER_NAME || 'mani-ᴍᴅ',
     ...
     * @type {string}
     */
    BOT_FOOTER: process.env.BOT_FOOTER || '© ᴘᴏᴡᴇʀᴇᴅ ʙʏ mani-ᴍᴅ',
     ...
     * @type {string}
     */
    CHANNEL_JID: process.env.CHANNEL_JID || '120363420486385183@newsletter',
     ...
     * @type {string}
     */
    IMAGE_PATH: process.env.IMAGE_PATH || 'https://i.ibb.co/vvMqY41p/92d880ac7534.jpg',

    /**
     * @description WhatsApp channel link for updates
     * @type {string}
     */
    CHANNEL_LINK: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029Vb60cZWI1rcauQ1lpn0Y',

    /**
     * @description WhatsApp group invite link
     * @type {string}
     */
    GROUP_LINK: process.env.GROUP_LINK || 'https://chat.whatsapp.com/GmdWc3gy7VBJ7FUu1YJy0C',

    /**
     * @description Owner WhatsApp link
     * @type {string}
     */
    OWNER_LINK: process.env.OWNER_LINK || 'https://wa.me/923317568033',

    /**
     * @description Repository link
     * @type {string}
     */
    REPO: process.env.REPO || 'https://github.com/',
